...
find /tmp/.wwebjs_auth -name "SingletonLock" -delete 2>/dev/null
find /tmp/.wwebjs_auth -name "SingletonCookie" -delete 2>/dev/null
find /tmp/.wwebjs_auth -name "SingletonSocket" -delete 2>/dev/null
